 ...
 * AdmSede.java
 *
 * Created on Oct 5, 2011, 2:52:22 PM
 */
package Mantenimiento.Sede;

/**
 *
 * @author DIEGO
 */
public class AdmSede extends javax.swing.JFrame {

    /** Creates new form AdmSede */
    public AdmSede() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "Departamento", "Provincia", "Distrito", "Teléfono", "Dirección"
            }
        ) {
    ...
    private void jLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MousePressed
        ...
        MantenimientoSede m = new MantenimientoSede();
        m.setVisible(true);
    }//GEN-LAST:event_jLabel1MousePressed

    private void jLabel4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MousePressed
        // TODO add your handling code here:
        BuscarSede b = new BuscarSede();
        b.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmSede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
