 ...
 * @author DIEGO
 */
public class OrdenDeEntrega extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("+Flow - Orden de Entrega");
        setResizable(false);
        ...
        jLabel1.setText("N° de Orden de Entrega:");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtOrden, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(117, 117, 117)
...
private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
    ...
    NotaIngresoBL niBL = new NotaIngresoBL();
     if (niBL.queryByIdNotaIngreso(this.txtOrden.getText())==null) {
            JOptionPane.showMessageDialog(null, "Orden de Entrega inválida.", "Error", 0);
            return;
        }


    runReporte(txtOrden.getText());// TODO add your handling code here:
...
private void txtOrdenKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtOrdenKeyTyped
       ...
       char c = (char)evt.getKeyChar();
        ...
        if ((this.txtOrden.getText().length() + 1) > 6) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdenDeEntrega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new OrdenDeEntrega().setVisible(true);
            }
        });
    }
