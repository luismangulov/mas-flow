...
/*
 * AdmOrdenDeSuministro.java
 *
 * Created on Oct 2, 2011, 3:50:03 PM
 */
 ...
 * @author DIEGO
 */
public class AdmOrdenDeSuministro extends javax.swing.JFrame {

    /** Creates new form AdmOrdenDeSuministro */
    public AdmOrdenDeSuministro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre solicitante", "Almacen "
            }
        ) {
...
MantenimientoOrdenDeSuministro m = new MantenimientoOrdenDeSuministro();
m.setVisible(true);
...
// TODO add your handling code here:
    BuscarOrdenDeSuministro m = new BuscarOrdenDeSuministro();
    m.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmOrdenDeSuministro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new AdmOrdenDeSuministro().setVisible(true);
            }
        });
    }
